...
st.markdown("""
<div style="background-color:#006e6d;padding:12px;border-radius:10px;text-align:center;line-height:1.2;">
    <h2 style="color:white;margin:0;">FP-Growth Dashboard</h2>
    <h2 style="color:white;margin:0;">Nuhsantara Merchandise</h2>
</div>
