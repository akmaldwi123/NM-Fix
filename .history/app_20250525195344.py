...
st.markdown("""
<div style="background-color:#006e6d;padding:30px 20px;border-radius:10px;text-align:center;">
    <h2 style="color:white;margin:0;line-height:1.2;">FP-Growth Dashboard<br>Nuhsantara Merchandise</h2>
</div>
""", unsafe_allow_html=True)

# Sidebar
page = st.sidebar.radio("\U0001F4C1 Menu Navigasi", ["\U0001F4E5 Upload File""\U0001F4C3 Data Transaksi", "\U0001F4CA FP-Growth Analisis", "\U0001F4E5 Upload File"])
...
if page == "\U0001F4C3 Data Transaksi":
    ...
    if "tanggal" in df_view.columns:
        ...
        df_view = df_view[(df_view["tanggal"] >= pd.to_datetime(tgl_start)) & (df_view["tanggal"] <= pd.to_datetime(tgl_end))]
