...
<div style="background-color:#006e6d;padding:10px;border-radius:10px;text-align:center;">
    <h2 style="color:white;margin:0;font-size:30px;line-height:1.0;">FP-Growth Dashboard</h2>
    <h2 style="color:white;margin:0;font-size:30px;line-height:1.0;">Nuhsantara Merchandise</h2>
</div>
